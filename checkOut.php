      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-md-3">
               ...
               <a href='#' data-toggle='modal' data-target='#beatsInfoModal'> <img src="Media/beats.png" width="50px"></a>
               <a href='#' data-toggle='modal' data-target='#boseInfoModal'> <img src="Media/bose.png" width="50px"></a>
               <a href='#' data-toggle='modal' data-target='#sonyInfoModal'> <img src="Media/sony.png" width="50px"></a>
               <a href='#' data-toggle='modal' data-target='#bowseInfoModal'> <img src="Media/bowse.png" width="50px"></a>
            </div>
         </div>
      </div>
      <!-- Order Summary Table -->
